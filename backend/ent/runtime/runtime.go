...
func init() {
	...
	user.OverdraftLimitValidator = func() func(float64) error {
		validators := userDescOverdraftLimit.Validators
		fns := [...]func(float64) error{
			validators[0].(func(float64) error),
			validators[1].(func(float64) error),
		}
		return func(overdraft_limit float64) error {
			for _, fn := range fns {
				if err := fn(overdraft_limit); err != nil {
					return err
				}
			}
			return nil
