...
func (u *UserUpsert) ClearOverdraftLimit() *UserUpsert {
	u.SetNull(user.FieldOverdraftLimit)
	return u
}
...
// ClearOverdraftLimit clears the value of the "overdraft_limit" field.
func (u *UserUpsertOne) ClearOverdraftLimit() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.ClearOverdraftLimit()
	})
}
...
// ClearOverdraftLimit clears the value of the "overdraft_limit" field.
func (u *UserUpsertBulk) ClearOverdraftLimit() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.ClearOverdraftLimit()
	})
}
